...
const GestionProyectosPorGerente = () => {
    ...
    <div className="container mt-4">
      ...
      <div className="row">
        {proyectos.map((proyecto) => (
          <div className="col-md-4 mb-4 d-flex" key={proyecto.idProyectos}>
            <div className="card shadow-sm w-100">
              <div className="card-body d-flex flex-column">
                ...
                <p className="card-text">
                  ...
                  {portafolios.find(
                    (p) => p.idPortafolio === proyecto.idPortafolio
                  )?.NombrePortafolio || "N/A"}
                </p>
                <p className="card-text">
                  <strong>Equipo:</strong>{" "}
                  {equipos.find(
                    (e) => e.idEquipos === proyecto.Equipos_idEquipos
                  )?.NombreEquipos || "N/A"}
                </p>
                <p className="card-text">
...
export default GestionProyectosPorGerente;
